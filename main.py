...
"""
        # Claude API call with required version header
        ...
        claude_response = requests.post(
            ...
            headers={
                ...
                "anthropic-version": "2024-07-15"  # Added required version header
            },
            json={
...
"""
        ...
        report_content = (
            ...
            f"**Uploaded**: {os.getenv('CURRENT_DATE', '2025-07-17 22:25:04 CDT')}\n"
