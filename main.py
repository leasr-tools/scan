...
"""
        ...
        grok_response = requests.post(
            os.getenv("GROK_API_URL", "https://api.x.ai/v1/messages"),  # Updated to /v1/messages
        ...
        grok_data = grok_response.json().get("content", [{}])[0].get("text", "{}")  # Adjusted for Anthropic compatibility
        ...
        report_content = (
            ...
            f"**Uploaded**: {os.getenv('CURRENT_DATE', '2025-07-17 20:19:00 CDT')}\n"  # Updated to current time
