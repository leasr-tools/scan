...
"""
        ...
        # Adjust parsing for OpenAI-like response
        grok_data = grok_response.json().get("choices", [{}])[0].get("message", {}).get("content", "{}")
        logger.debug(f"Grok raw data: {grok_data}")  # Debug to verify content
