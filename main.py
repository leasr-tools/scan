...
"""
        ...
        logger.debug(f"Grok extracted JSON: {grok_data}")
        ...
        story.append(Paragraph(f"<b>Uploaded</b>: {os.getenv('CURRENT_DATE', '2025-07-18 00:21:00 CDT')}", styles['Normal']))  # Updated to current time
