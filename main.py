...
async def process_lease(request: Request):
    ...
    try:
        ...
        r = requests.get(file_url, timeout=30)  # Added timeout to prevent hangs
        r.raise_for_status()
...
"""
        # Claude API call with required version header and timeout
        ...
        claude_response = requests.post(
            ...
            headers={
                ...
                "anthropic-version": "2024-07-15"
            },
            json={
                "model": "claude-sonnet-4-20250514",
                "max_tokens": 4000,
                "messages": [{"role": "user", "content": f"{claude_prompt}\n{text[:50000]}"}]  # Reduced to 50k chars to test
            },
            timeout=60  # Added timeout to catch hangs
        )
...
"""
        ...
        report_content = (
            ...
            f"**Uploaded**: {os.getenv('CURRENT_DATE', '2025-07-18 00:14:11 CDT')}\n"
