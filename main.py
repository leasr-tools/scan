...
"""
        # Claude API call with updated model and version header
        ...
        claude_response = requests.post(
            ...
            json={
                "model": "claude-sonnet-4-20250514",  # Updated to new model
                "max_tokens": 4000,
...
"""
        ...
        report_content = (
            ...
            f"**Uploaded**: {os.getenv('CURRENT_DATE', '2025-07-17 19:28:00 CDT')}\n"  # Updated to current time
